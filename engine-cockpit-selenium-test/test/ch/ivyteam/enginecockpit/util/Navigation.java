...
public class Navigation {
  ...
  private static final String DASHBOARD_MENU = "#sidebarMenu\\:menuform\\:sr_dashboard";
  private static final String APPLICATIONS_MENU = "#sidebarMenu\\:menuform\\:sr_applications";
  ...
  private static final String SECURITY_ROLES_MENU = "#sidebarMenu\\:menuform\\:sr_roles";
  private static final String CONFIGURATION_MENU = "#sidebarMenu\\:menuform\\:sr_configuration";
  private static final String VARIABLES_MENU = "#sidebarMenu\\:menuform\\:sr_variables";
  private static final String BUSINESS_CALENDAR_MENU = "#sidebarMenu\\:menuform\\:sr_business_calendar";
  private static final String BRANDING_MENU = "#sidebarMenu\\:menuform\\:sr_branding";
  private static final String SSL_MENU = "#sidebarMenu\\:menuform\\:sr_ssl";
  private static final String SERVICES_MENU = "#sidebarMenu\\:menuform\\:sr_services";
  private static final String SERVICES_SEARCH_ENGINE = "#sidebarMenu\\:menuform\\:sr_searchengine";
  private static final String SERVICES_NOTIFICATION_CHANNELS_MENU = "#sidebarMenu\\:menuform\\:sr_notification_channels";
  private static final String SERVICES_DATABASES_MENU = "#sidebarMenu\\:menuform\\:sr_database";
  private static final String SERVICES_RESTCLIENTS_MENU = "#sidebarMenu\\:menuform\\:sr_rest_client";
  private static final String SERVICES_WEBSERVICES_MENU = "#sidebarMenu\\:menuform\\:sr_web_service";
  private static final String SERVICES_WEBSERVICEPROCESSES_MENU = "#sidebarMenu\\:menuform\\:sr_web_service_processes";
  private static final String SERVICES_REST_SERVICES_MENU = "#sidebarMenu\\:menuform\\:sr_rest_services";
  private static final String SYSTEM_MENU = "#sidebarMenu\\:menuform\\:sr_system";
  private static final String SYSTEM_ADMINS = "#sidebarMenu\\:menuform\\:sr_admins";
  private static final String SYSTEM_SYSTEMDB_MENU = "#sidebarMenu\\:menuform\\:sr_systemdb";
  private static final String SYSTEM_LICENCE = "#sidebarMenu\\:menuform\\:sr_licence";
  private static final String SYSTEM_WEB_SERVER_MENU = "#sidebarMenu\\:menuform\\:sr_web_server";
  private static final String SYSTEM_CONFIG_MENU = "#sidebarMenu\\:menuform\\:sr_system_config";
  private static final String SYSTEM_CLUSTER = "#sidebarMenu\\:menuform\\:sr_cluster";
  private static final String SYSTEM_EDITOR_MENU = "#sidebarMenu\\:menuform\\:sr_editor";
  private static final String MONITOR_MENU = "#sidebarMenu\\:menuform\\:sr_monitor";
  private static final String MONITOR_OS_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_os";
  private static final String MONITOR_LOGS_MENU = "#sidebarMenu\\:menuform\\:sr_logs";
  private static final String MONITOR_JAVA_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_java";
  private static final String MONITOR_JAVA_JVM_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_java_jvm";
  private static final String MONITOR_JAVA_MEMORY_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_java_memory";
  private static final String MONITOR_JAVA_CLASS_HISTOGRAM = "#sidebarMenu\\:menuform\\:sr_monitor_java_class_histogram";
  private static final String MONITOR_JAVA_THREADS = "#sidebarMenu\\:menuform\\:sr_monitor_java_threads";
  private static final String MONITOR_JAVA_JFR = "#sidebarMenu\\:menuform\\:sr_monitor_java_jfr";
  private static final String MONITOR_JAVA_MBEANS_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_java_mbeans";
  private static final String MONITOR_ENGINE_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_engine";
  private static final String MONITOR_ENGINE_CACHE_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_engine_cache";
  private static final String MONITOR_ENGINE_SESSION_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_engine_sessions";
  private static final String MONITOR_ENGINE_NOTIFICATION_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_engine_notification";
  private static final String MONITOR_ENGINE_JOBS_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_engine_jobs";
  private static final String MONITOR_ENGINE_HEALTH_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_engine_health";
  private static final String MONITOR_WORKFLOW_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_workflow";
  private static final String MONITOR_WORKFLOW_DOCUMENTS_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_workflow_documents";
  private static final String MONITOR_WORKFLOW_START_EVENTS_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_workflow_start_events";
  private static final String MONITOR_WORKFLOW_INTERMEDIATE_EVENTS_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_workflow_intermediate_events";
  private static final String MONITOR_PERFORMANCE_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_performance";
  private static final String MONITOR_PERFORMANCE_PROCESS_EXECUTION_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_performance_process_execution";
  private static final String MONITOR_PERFORMANCE_TRACES_MENU = "#sidebarMenu\\:menuform\\:sr_monitor_performance_traces";
  private static final String MONITOR_PERFORMANCE_TRAFFIC_GRAPH = "#sidebarMenu\\:menuform\\:sr_monitor_performance_traffic_graph";
