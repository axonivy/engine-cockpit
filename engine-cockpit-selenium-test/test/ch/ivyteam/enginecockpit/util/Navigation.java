...
public class Navigation {
  ...
  private static final String MONITOR_ENGINE_FILES_MENU = "#menuform\\:sr_monitor_engine_files";
  ...
  public static void toFiles() {
    toSubSubMenu(MONITOR_MENU, MONITOR_ENGINE_MENU, MONITOR_ENGINE_FILES_MENU);
    assertCurrentUrlContains("files.xhtml");
    menuShouldBeActive(MONITOR_ENGINE_FILES_MENU);
  }
