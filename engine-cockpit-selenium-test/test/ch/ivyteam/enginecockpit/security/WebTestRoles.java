...
public class WebTestRoles extends WebTestBase
{
  ...
  void testRolesInTable()
  {
    ...
    WebElement panel = getVisibleRolePanel();
    ...
    saveScreenshot();
    webAssertThat(() -> assertThat(getVisibleRolePanel().findElements(By.xpath("//*[contains(@class, 'ui-treenode-content')]")).stream()
              .filter(found -> found.isDisplayed()).collect(Collectors.toList())).hasSize(1));
  }

  private WebElement getVisibleRolePanel()
  {
