pipeline {
  ...
  parameters {
    string(name: 'engineSource', defaultValue: 'https://jenkins.ivyteam.io/job/ivy-core_product/job/codeCamp%252FengineMigration/lastSuccessfulBuild/', description: 'Engine page url')
