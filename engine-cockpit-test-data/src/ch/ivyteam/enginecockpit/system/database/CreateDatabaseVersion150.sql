...
(
  ...
  INDEX IWA_AsyncProcessCaseData_CaseIdIndex (CaseId)
) ENGINE=InnoDB;
...
(
  ...
  UNIQUE (Name),
  INDEX IWA_Application_SecuritySystemIdIndex (SecuritySystemId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_ProcessModel_ApplicationIdIndex (ApplicationId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_ProcessModelVersion_ProcessModelIdIndex (ProcessModelId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_Library_ApplicationIdIndex (ApplicationId)
) ENGINE=InnoDB;
...
(
  ...
  UNIQUE (LibraryId, Id),
  INDEX IWA_LibrarySpecification_LibraryIdIndex (LibraryId),
...
(
  ...
  INDEX IWA_LibraryVersionSpec_LibrarySpecificationIdIndex (LibrarySpecificationId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_CaseMap_ProcessModelVersionIdIndex (ProcessModelVersionId),
  INDEX IWA_CaseMap_ApplicationIdIndex (ApplicationId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_SecurityMember_SecuritySystemIdIndex (SecuritySystemId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_Role_SecuritySystemIdIndex (SecuritySystemId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_RoleRoleMember_RoleSecurityMemberIdIndex (RoleSecurityMemberId),
  INDEX IWA_RoleRoleMember_RoleMemberSecurityMemberIdIndex (RoleMemberSecurityMemberId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_User_SecuritySystemIdIndex (SecuritySystemId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_UserRole_RoleSecurityMemberIdIndex (RoleSecurityMemberId),
  INDEX IWA_UserRole_UserSecurityMemberIdIndex (UserSecurityMemberId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_TaskElement_ProcessModelVersionIdIndex (ProcessModelVersionId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_TaskStart_TaskElementIdIndex (TaskElementId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_TaskEnd_TaskElementIdIndex (TaskElementId)
) ENGINE=InnoDB;
...
(
  ...
  TaskElementId BIGINT NOT NULL,
  CaseId BIGINT NOT NULL,
  ExecutionTimestamp DATETIME(3) NOT NULL,
  PRIMARY KEY (TaskSwitchEventId),
  INDEX IWA_TaskSwitchEvent_TaskElementIdIndex (TaskElementId),
  INDEX IWA_TaskSwitchEvent_CaseIdIndex (CaseId)
) ENGINE=InnoDB;
...
(
  ...
  StartTimestamp DATETIME(3) NOT NULL,
  EndTimestamp DATETIME(3),
  ModifiedTimestamp DATETIME(3) NOT NULL,
  ...
  INDEX IWA_Case_ActivatorIdIndex (ActivatorId),
  ...
  INDEX IWA_Case_StateIndex (`State`),
  INDEX IWA_Case_BusinessStateIndex (BusinessState),
...
(
  ...
  INDEX IWA_CaseLocalized_CaseIdIndex (CaseId),
  INDEX IWA_CaseLocalized_LanguageIdIndex (LanguageId)
) ENGINE=InnoDB;
...
(
  ...
  WorkingTime BIGINT,
  BusinessRuntime BIGINT,
  FailedTimeoutTimestamp DATETIME(3),
  ...
  INDEX IWA_Task_BusinessStateIndex (BusinessState),
  ...
  INDEX IWA_Task_StartTaskSwitchEventIdIndex (StartTaskSwitchEventId),
  INDEX IWA_Task_EndTaskSwitchEventIdIndex (EndTaskSwitchEventId),
  INDEX IWA_Task_TaskStartIdIndex (TaskStartId),
  INDEX IWA_Task_TaskEndIdIndex (TaskEndId),
  INDEX IWA_Task_ExpiredCreatorTaskIdIndex (ExpiredCreatorTaskId),
  INDEX IWA_Task_TimeoutedCreatorIntrmdtEventIdIndex (TimeoutedCreatorIntrmdtEventId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_TaskLocalized_TaskIdIndex (TaskId),
  INDEX IWA_TaskLocalized_LanguageIdIndex (LanguageId)
) ENGINE=InnoDB;
...
(
  ...
  ProcessingRetryTimestamp DATETIME(3),
  ...
  INDEX IWA_CaseMapEvent_ProcessCaseIdIndex (ProcessCaseId)
) ENGINE=InnoDB;
...
(
  ...
  `State` INTEGER NOT NULL,
  EventTimestamp DATETIME(3),
  TimeoutTimestamp DATETIME(3),
  ...
  INDEX IWA_IntermediateEvent_ApplicationId (ApplicationId),
...
(
  ...
  INDEX IWA_TaskNote_TaskIdIndex (TaskId),
  INDEX IWA_TaskNote_NoteIdIndex (NoteId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_CaseNote_CaseIdIndex (CaseId),
  INDEX IWA_CaseNote_NoteIdIndex (NoteId)
) ENGINE=InnoDB;
...
(
  ...
  FOREIGN KEY (TaskId) REFERENCES IWA_Task(TaskId) ON DELETE CASCADE,
  UNIQUE (TaskId, Name),
  INDEX IWA_TaskCustomStringField_TaskIdIndex (TaskId),
...
(
  ...
  INDEX IWA_TaskCustomTextField_TaskIdIndex (TaskId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_TaskCustomNumberField_TaskIdIndex (TaskId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_TaskCustomTimestampField_TaskIdIndex (TaskId)
) ENGINE=InnoDB;
...
(
  ...
  FOREIGN KEY (CaseId) REFERENCES IWA_Case(CaseId) ON DELETE CASCADE,
  UNIQUE (CaseId, Name),
  INDEX IWA_CaseCstmStringFld_CaseIdIndex (CaseId),
...
(
  ...
  INDEX IWA_CaseCstmTextFld_CaseIdIndex (CaseId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_CaseCstmNumberFld_CaseIdIndex (CaseId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_CaseCstmTmstmpFld_CaseIdIndex (CaseId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_TskSigEvntRcvr_SgTskTskId (SignaledTaskTaskStartId),
...
(
  ...
  SentTimestamp DATETIME(3) NOT NULL,
  ...
  INDEX IWA_SignalEvent_SecuritySystemId (SecuritySystemId),
  INDEX IWA_SignalEvent_ApplicationId (ApplicationId),
...
(
  ...
  INDEX IWA_SecurityDescriptor_SecurityDescriptorTypeId (SecurityDescriptorTypeId)
) ENGINE=InnoDB;
...
(
  ...
  UNIQUE (Name),
  INDEX IWA_SecuritySystem_SecurityDescriptorId (SecurityDescriptorId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_PermissionGroup_ParentPermissionGroupId (ParentPermissionGroupId)
) ENGINE=InnoDB;
...
(
  ...
  UNIQUE (Name),
  INDEX IWA_SecurityDescriptorType_RootPermissionGroupId (RootPermissionGroupId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_AccessControl_PermissionIdIdx (PermissionId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_PermissionGroupPermission_PermissionGroupId (PermissionGroupId),
  INDEX IWA_PermissionGroupPermission_PermissionId (PermissionId)
) ENGINE=InnoDB;

CREATE TABLE IWA_Blob
(
  ...
  CreatorId VARCHAR(210) NOT NULL,
  CreatedAt DATETIME(3) NOT NULL,
  `Size` BIGINT NOT NULL,
  ModifierId VARCHAR(210) NOT NULL,
  ...
  FOREIGN KEY (SecuritySystemId) REFERENCES IWA_SecuritySystem(SecuritySystemId),
  FOREIGN KEY (CreatorId) REFERENCES IWA_SecurityMember(SecurityMemberId),
  FOREIGN KEY (ModifierId) REFERENCES IWA_SecurityMember(SecurityMemberId),
  UNIQUE (BlobId),
  UNIQUE (SecuritySystemId, `Path`),
  UNIQUE (ApplicationId, FilePath),
  INDEX IWA_Blob_FilePath (FilePath(255)),
  INDEX IWA_Blob_Path (`Path`(255)),
  INDEX IWA_Blob_CreatorId (CreatorId),
  INDEX IWA_Blob_ModifierId (ModifierId),
  INDEX IWA_Blob_CreatedAt (CreatedAt),
  INDEX IWA_Blob_FileName (FileName),
  INDEX IWA_Blob_ModifiedAt (ModifiedAt),
  INDEX IWA_Blob_SecuritySystemId (SecuritySystemId),
  INDEX IWA_Blob_ApplicationId (ApplicationId)
) ENGINE=InnoDB;
...
(
  ...
  INDEX IWA_BusinessCaseData_BusinessCaseId (BusinessCaseId)
) ENGINE=InnoDB;

CREATE TABLE IWA_Notification
(
  NotificationId VARCHAR(36) NOT NULL,
  Kind VARCHAR(100) NOT NULL,
  Payload TEXT NOT NULL,
  SecuritySystemId BIGINT NOT NULL,
  ReceiverId VARCHAR(210) NOT NULL,
  CreatedAt DATETIME(3) NOT NULL,
  IsUshered BIT NOT NULL,
  PRIMARY KEY (NotificationId),
  FOREIGN KEY (SecuritySystemId) REFERENCES IWA_SecuritySystem(SecuritySystemId) ON DELETE CASCADE,
  FOREIGN KEY (ReceiverId) REFERENCES IWA_SecurityMember(SecurityMemberId) ON DELETE CASCADE,
  INDEX IWA_Notification_KindIndex (Kind),
  INDEX IWA_Notification_SecuritySystemIdIndex (SecuritySystemId),
  INDEX IWA_Notification_ReceiverIdIndex (ReceiverId),
  INDEX IWA_Notification_CreatedAtIndex (CreatedAt)
) ENGINE=InnoDB;

CREATE TABLE IWA_NotificationDelivery
(
  NotificationDeliveryId VARCHAR(36) NOT NULL,
  ...
  Error VARCHAR(255),
  ErrorTimeoutTimestamp DATETIME(3),
  NumberOfErrors INTEGER NOT NULL,
  PRIMARY KEY (NotificationDeliveryId),
  FOREIGN KEY (NotificationId) REFERENCES IWA_Notification(NotificationId) ON DELETE CASCADE,
  FOREIGN KEY (ReceiverId) REFERENCES IWA_SecurityMember(SecurityMemberId) ON DELETE CASCADE,
  INDEX IWA_NotificationDelivery_NotificationIdIndex (NotificationId),
  INDEX IWA_NotificationDelivery_ChannelIndex (Channel),
  INDEX IWA_NotificationDelivery_ReceiverIdIndex (ReceiverId),
  INDEX IWA_NotificationDelivery_DeliveredAtIndex (DeliveredAt),
  INDEX IWA_NotificationDelivery_ReadAtIndex (ReadAt),
  INDEX IWA_NotificationDelivery_HideIndex (Hide),
  INDEX IWA_NotificationDelivery_DeliveryStateIndex (DeliveryState)
) ENGINE=InnoDB;

CREATE TABLE IWA_NotificationSubscription
(
  NotificationSubscriptionId BIGINT NOT NULL,
  Channel VARCHAR(100) NOT NULL,
  Kind VARCHAR(100) NOT NULL,
  SubscriberId VARCHAR(210) NOT NULL,
  Subscribed BIT NOT NULL,
  PRIMARY KEY (NotificationSubscriptionId),
  FOREIGN KEY (SubscriberId) REFERENCES IWA_SecurityMember(SecurityMemberId) ON DELETE CASCADE,
  UNIQUE (SubscriberId, Kind, Channel),
  INDEX IWA_NotificationSubscription_ChannelIndex (Channel),
  INDEX IWA_NotificationSubscription_KindIndex (Kind),
  INDEX IWA_NotificationSubscription_SubscriberIdIndex (SubscriberId)
) ENGINE=InnoDB;
...
ALTER TABLE IWA_AccessControl ADD
(
 FOREIGN KEY (PermissionId) REFERENCES IWA_Permission(PermissionId) ON DELETE CASCADE
);

INSERT INTO IWA_Version (Version) VALUES (150);
