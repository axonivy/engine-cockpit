    ...
    implements Serializable
{
     ...
     * This is why there is not a {@code set} method for the includeOrImportOrRedefine property.</p>
     * 
     * <p>
     ...
     * not a snapshot. Therefore, any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the simpleTypeOrComplexTypeOrGroup property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * not a snapshot. Therefore, any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the finalDefault property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * not a snapshot. Therefore, any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the blockDefault property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
