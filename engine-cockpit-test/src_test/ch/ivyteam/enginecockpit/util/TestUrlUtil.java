...
public class TestUrlUtil
{
  ...
  void docBaseUrls()
  {
    assertThat(UrlUtil.getEngineGuideBaseUrl()).isEqualTo("https://developer.axonivy.com/doc/dev/engine-guide");
    assertThat(UrlUtil.getCockpitEngineGuideUrl()).isEqualTo("https://developer.axonivy.com/doc/dev/engine-guide/tool-reference/engine-cockpit/");
    assertThat(UrlUtil.getDesignerGuideBaseUrl()).isEqualTo("https://developer.axonivy.com/doc/dev/designer-guide");
  }
