...
{    
  ...
  public void heapMemoryMonitor()
  {
    ...
    assertThat(testee.getHeapMemoryMonitor().getInfo()).contains("Heap Memory: Used", ", Committed ", ", Init ", ", Max ");
  }
  ...
  public void garbageCollectorsMonitor()
  {
    ...
    assertThat(testee.getGarbageCollectorsMonitor().getInfo()).contains("Garbage Collection: G1 Young Generation ", "Count", ", G1 Old Generation", "Count");
  }
}
