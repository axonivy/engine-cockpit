...
public class TestValueProvider
{
  ...
  {
    assertThatNextValue(ValueProvider.format("value %d", () -> new Value(1234, Unit.BYTES))).isEqualTo("value 1234 B");
    assertThatNextValue(ValueProvider.format("%d value", () -> new Value(123456789, Unit.BYTES))).isEqualTo("123456789 B value");
    assertThatNextValue(ValueProvider.format("value %3d", () -> new Value(1234, Unit.BYTES))).isEqualTo("value 1 KiB");
    assertThatNextValue(ValueProvider.format("value %3d", () -> new Value(12345, Unit.BYTES))).isEqualTo("value 12 KiB");
    assertThatNextValue(ValueProvider.format("value %3d", () -> new Value(12345678, Unit.BYTES))).isEqualTo("value 11 MiB");
    assertThatNextValue(ValueProvider.format("value %4d", () -> new Value(12345678, Unit.BYTES))).isEqualTo("value 11 MiB");
    assertThatNextValue(ValueProvider.format("value %5d", () -> new Value(12345678, Unit.BYTES))).isEqualTo("value 12056 KiB");
  ...
  {
    assertThatNextValue(ValueProvider.format("value %f", () -> new Value(1.234, Unit.KILO_BYTES))).isEqualTo("value 1.234000 KiB");
    assertThatNextValue(ValueProvider.format("value %.1f", () -> new Value(1.234, Unit.KILO_BYTES))).isEqualTo("value 1.2 KiB");
  ...
  {
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(1234, Unit.MICRO_SECONDS))).isEqualTo("value 1234 us");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(12345, Unit.MICRO_SECONDS))).isEqualTo("value 12 ms");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(123456, Unit.MICRO_SECONDS))).isEqualTo("value 123 ms");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(1234567, Unit.MICRO_SECONDS))).isEqualTo("value 1234 ms");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(12345678, Unit.MICRO_SECONDS))).isEqualTo("value 12 s");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(123456789, Unit.MICRO_SECONDS))).isEqualTo("value 123 s");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(1234567, Unit.MILLI_SECONDS))).isEqualTo("value 20 m");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(12345678, Unit.MILLI_SECONDS))).isEqualTo("value 205 m");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(123456789, Unit.MILLI_SECONDS))).isEqualTo("value 34 h");
    assertThatNextValue(ValueProvider.format("value %t", () -> new Value(1234567, Unit.SECONDS))).isEqualTo("value 14 d");
  ...
  {
    ValueProvider derivation = ValueProvider.derivation(ValueProvider.value(() -> counter*counter, Unit.ONE), increase());
