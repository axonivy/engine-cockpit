...
import ch.ivyteam.enginecockpit.model.LibSpecification;
...
public class PmvDetailBean
{
  ...
  private void reloadDetailPmv()
  {
    ...
    IProcessModelVersion iPmv = managerBean.getManager().findProcessModelVersion(appName, pmName, Integer.parseInt(pmvVersion));
    if (iPmv == null) {
