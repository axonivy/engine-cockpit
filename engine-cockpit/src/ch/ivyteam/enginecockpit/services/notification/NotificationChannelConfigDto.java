...
public class NotificationChannelConfigDto {
  ...
  public static NotificationChannelConfigDto instance(ISecurityContext securityContext, NotificationChannel channel) {
  ...
  public static List<NotificationChannelConfigDto> all(ISecurityContext securityContext) {
    return NotificationChannel.all().stream()
            .map(channel -> NotificationChannelConfigDto.instance(securityContext, channel))
            .collect(Collectors.toList());
  }
