...
public class MailClientMonitorBean
{
  ...
  private final Monitor executionTimeMonitor = Monitor.build().name("Execution Time").title("Mail Sending Execution Time").icon("timer").yAxisLabel("Execution Time").toMonitor();
